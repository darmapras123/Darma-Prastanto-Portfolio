// app/home/Project/ProjectItems/CertificateBapas.tsx
"use client";
...
export default function CertificateBapas({ onViewerOpenChange }: Props) {
    ...
    <figure className="text-left">
      ...
      >
        ...
        <button
          type="button"
          onClick={() => setOpen(true)}
          aria-label="Lihat detail Sertifikat KlikBapas"
          className={[
      ...
      <ModalBottomSheet
        ...
        ariaLabel="Pratinjau sertifikat KlikBapas"
        ...
        <div className="relative w-full">
          ...
          <div className="px-4 pt-2 text-white sm:px-6 sm:pt-5 sm:absolute sm:left-6 sm:top-5 sm:z-20">
            <p className="text-sm sm:text-base font-semibold leading-tight">
              Pengembangan Sistem Layanan Digital KlikBapas
            </p>

            <div className="mt-0.5 flex items-center gap-2">
              <span className="text-xs sm:text-sm opacity-90 leading-tight">Balai Pemasyarakatan Kelas II Magelang</span>
            ...
            <div className="mt-2">
              <a
                href="/certificates/KlikBapas.png"
                download="KlikBapas.png"
                className={[
