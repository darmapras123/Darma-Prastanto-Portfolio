// app/home/Project/ProjectItems/CertificateKemnaker.tsx
"use client";
...
export default function CertificateKemnaker({ onViewerOpenChange }: Props) {
    ...
    <figure className="text-left">
      ...
      >
        ...
        <button
          type="button"
          onClick={() => setOpen(true)}
          aria-label="Lihat detail Sertifikat Kemnaker"
          className={[
      ...
      <ModalBottomSheet
        ...
        ariaLabel="Pratinjau sertifikat Kemnaker"
        widthClassName="w-[96vw] sm:w-[84vw]"
        maxWidthClassName="max-w-[1100px]"
        maxHeightClassName="max-h-[100svh] sm:max-h-[90vh]"
      >
        <button
          type="button"
        ...
        <div className="relative w-full">
          <div className="px-4 pt-2 text-white sm:px-6 sm:pt-5 sm:absolute sm:left-6 sm:top-5 sm:z-20">
            <p className="text-sm sm:text-base font-semibold leading-tight">
              Sertifikat Pemagangan - Kementerian Ketenagakerjaan RI
            </p>
            <div className="mt-0.5 flex items-center gap-2">
              <span className="text-xs sm:text-sm opacity-90 leading-tight">Kemnaker x Bapas Magelang</span>
            ...
            <div className="mt-2">
              <a
                href="/certificates/kemnaker.png"
                download="kemnaker.png"
                className="relative overflow-hidden inline-flex items-center gap-2 px-3 py-1.5 rounded-md border bg-[#1f2a3a] hover:bg-[#243048] active:bg-[#1b2436] border-[#2a3950] text-white shadow transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
              >
                <span aria-hidden className="pointer-events-none absolute -top-1/2 left-[-60%] h-[230%] w-[60%] shimmer-diag shimmer-run" />
          ...
          <div className="mx-auto w-[90vw] sm:w-full sm:max-w-[560px] md:max-w-[680px] lg:max-w-[760px] pt-0 sm:pt-[100px]">
            <Image
              src="/certificates/kemnaker.png"
              alt="Sertifikat Kemnaker"
      ...
      <style jsx>{`
        .shimmer-diag {
          background: linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(255,255,255,0.28) 32%, rgba(255,255,255,0.78) 50%, rgba(255,255,255,0.28) 68%, rgba(255,255,255,0) 100%);
          filter: blur(0.2px);
