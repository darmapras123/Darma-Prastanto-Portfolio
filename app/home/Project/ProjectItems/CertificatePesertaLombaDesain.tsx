// app/home/Project/ProjectItems/CertificatePesertaLombaDesain.tsx
"use client";
...
// const BUTTON_BOTTOM = 104; // (tak perlu lagi; diganti class Tailwind bottom-[104px])

export default function CertificatePesertaLombaDesain({ onViewerOpenChange }: Props) {
  ...
  // Saat modal ditutup, matikan hover hanya jika pointer benar2 di luar elemen
  useEffect(() => {
    if (!open) {
    ...
    <figure className="text-left">
      ...
      >
        ...
        <button
          ...
          aria-label="Buka pratinjau sertifikat Peserta Lomba Desain"
          className="relative z-10 inline-block focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/70 rounded-md"
        >
          <Image
            src="/certificates/PesertaLombaDesain.png"
            alt="Peserta Lomba Desain (thumbnail)"
            className={[
        ...
        {/* Tombol LIHAT DETAIL — border & garis hitam, teks hitam */}
        <button
          type="button"
          onClick={() => setOpen(true)}
          aria-label="Lihat detail Peserta Lomba Desain"
          className={[
            ...
            "bottom-[104px]", // ⬅️ ganti inline style jadi util Tailwind literal
          ].join(" ")}
        >
          <span
            aria-hidden
      ...
      {/* ===== Modal (mobile lebih panjang; desktop tetap) ===== */}
      <ModalBottomSheet
        open={open}
        onClose={() => setOpen(false)}
        ariaLabel="Pratinjau sertifikat Peserta Lomba Desain"
      ...
      >
        ...
        <div className="relative w-full">
          {/* Info + Download: mobile flow (px-4 pt-2), desktop absolute seperti semula */}
          <div className="px-4 pt-2 text-white sm:px-6 sm:pt-5 sm:absolute sm:left-6 sm:top-5 sm:z-20">
            <p className="text-sm sm:text-base font-semibold leading-tight">
              Peserta lomba desain poster — Hari Anti Narkoba Nasional
            </p>

            <div className="mt-0.5 flex items-center gap-2">
              <span className="text-xs sm:text-sm opacity-90 leading-tight">UNESA • MCC • BNN</span>
            ...
            <div className="mt-2">
              <a
                href="/certificates/PesertaLombaDesain.png"
                download="PesertaLombaDesain.png"
                className={[
